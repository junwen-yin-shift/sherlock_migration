...
aws s3 sync s3://axa-sherlock-data-science s3://sh-shck-ml-misc-work-build --include 'backup-instances/all/xiaohan.zip' --acl bucket-owner-full-control --quiet
...
echo "start to copy s3 bucket : from axa-sherlock-ml-artifacts-uk-ci-build to sh-shck-ml-artifacts-uk-work-build"
aws s3 sync s3://axa-sherlock-ml-artifacts-uk-ci-build s3://sh-shck-ml-artifacts-uk-work-build --exclude 'backups/*' --acl bucket-owner-full-control --quiet
...
ENTITY_LIST=("italy" "quixa" "ireland" "hk")
